...
public class XueshengchengjiEntity<T> implements Serializable {
     ...
     * 成绩
     */
    @TableField(value = "xueshengchengji_num")

    private Integer xueshengchengjiNum;
	 ...
	 * 设置：成绩
	 */
    public Integer getXueshengchengjiNum() {
        return xueshengchengjiNum;
    }
    /**
	 * 获取：成绩
	 */

    public void setXueshengchengjiNum(Integer xueshengchengjiNum) {
        this.xueshengchengjiNum = xueshengchengjiNum;
    }
    /**
	 * 设置：详情
	 */
    ...
    public String toString() {
        return "Xueshengchengji{" +
            ...
            ", xueshengchengjiNum=" + xueshengchengjiNum +
