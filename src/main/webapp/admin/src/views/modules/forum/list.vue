            ...
            <el-table :data="forumData" height="250">
                ...
                <el-table-column property="caozuo" label="操作">
                    <template slot-scope="scope">
                        ...
                        <el-button v-if="isAuth('forum','删除')&& (role == '管理员' || (role == '学生' && scope.row.yonghuId == userId)|| (role == '教师' && scope.row.jiaoshiId == userId))" type="danger" @click="deleteForumData(scope.row.id)" >删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <div class="demo-input-suffix">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/zaixiankaifangkechengw/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('forum','删除')&& (role == '管理员' || (role == '学生' && scope.row.yonghuId == userId)|| (role == '教师' && scope.row.jiaoshiId == userId))" type="danger" icon="el-icon-delete" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
