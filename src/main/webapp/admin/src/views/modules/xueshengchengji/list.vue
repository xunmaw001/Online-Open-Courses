        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '标题' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.xueshengchengjiName" placeholder="标题" clearable></el-input>
                     </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/zaixiankaifangkechengw/upload/xueshengchengjiMuBan.xls"
                        >批量导入学生成绩数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('xueshengchengji','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="xueshengchengjiTypes"
                                      header-align="center"
                                      label="学科类型">
                        <template slot-scope="scope">
                            {{scope.row.xueshengchengjiValue}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="xueshengchengjiNum"
                                      header-align="center"
                                      label="成绩">
                        <template slot-scope="scope">
                            {{scope.row.xueshengchengjiNum}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="xueshengchengjiText"
                                      header-align="center"
                                      label="详情">
                        <template slot-scope="scope">
                            <span v-if="scope.row.xueshengchengjiText != null &&scope.row.xueshengchengjiText.length>10">
                                {{scope.row.xueshengchengjiText.slice(0,10)}}...
                            </span>
                            <span v-else>
                                {{scope.row.xueshengchengjiText}}
                            </span>
                        </template>
                    </el-table-column>
...
<script>
    ...
    //当前表下拉框搜索条件
            form:{
                ...
                xueshengchengjiTypes : null,
                xueshengchengjiNum : null,
                xueshengchengjiText : null,
                insertTime : null,
                createTime : null,
            },
            dataList: [],
            ...
            json_fields: {
                //级联表字段
                     ...
                     '邮箱': 'yonghuEmail',
                //本表字段
                     '标题': "xueshengchengjiName",
                     '学科类型': "xueshengchengjiTypes",
                     '成绩': "xueshengchengjiNum",
                     '详情': "xueshengchengjiText",
                     '添加时间': "insertTime",
            },
