    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="标题" prop="xueshengchengjiName">
                       <el-input v-model="ruleForm.xueshengchengjiName"
                                 placeholder="标题" clearable  :readonly="ro.xueshengchengjiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="标题" prop="xueshengchengjiName">
                           <el-input v-model="ruleForm.xueshengchengjiName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="学科类型" prop="xueshengchengjiTypes">
                        <el-select v-model="ruleForm.xueshengchengjiTypes" :disabled="ro.xueshengchengjiTypes" placeholder="请选择学科类型">
                            <el-option
                                v-for="(item,index) in xueshengchengjiTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="学科类型" prop="xueshengchengjiValue">
                        <el-input v-model="ruleForm.xueshengchengjiValue"
                            placeholder="学科类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="成绩" prop="xueshengchengjiNum">
                       <el-input v-model="ruleForm.xueshengchengjiNum"
                                 placeholder="成绩" clearable  :readonly="ro.xueshengchengjiNum"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="成绩" prop="xueshengchengjiNum">
                           <el-input v-model="ruleForm.xueshengchengjiNum"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="详情" prop="xueshengchengjiText">
                        <el-input type="textarea"  :readonly="ro.xueshengchengjiText" v-model="ruleForm.xueshengchengjiText" placeholder="详情"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xueshengchengjiText" label="详情" prop="xueshengchengjiText">
                            <span v-html="ruleForm.xueshengchengjiText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    xueshengchengjiTypes: false,
                    xueshengchengjiNum: false,
                    xueshengchengjiText: false,
                    insertTime: false,
                },
                ruleForm: {
                    jiaoshiId: '',
                    yonghuId: '',
                    xueshengchengjiName: '',
                    xueshengchengjiTypes: '',
                    xueshengchengjiNum: '',
                    xueshengchengjiText: '',
                    insertTime: '',
                },
                xueshengchengjiTypesOptions : [],
                jiaoshiOptions : [],
                yonghuOptions : [],
                rules: {
                   jiaoshiId: [
                   ...
                   xueshengchengjiTypes: [
                              { required: true, message: '学科类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=xueshengchengji_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.xueshengchengjiTypesOptions = data.data.list;
                    }
                });
